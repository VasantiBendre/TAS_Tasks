...
class Game extends JPanel
{
	...
	private boolean didLoadBallImage = true;
	...
	private static int DELAY = 50;
	  ...
	  public Game() {
	    ...
	    private void update() {
	        ...
	        if (ball != null && snake.getHead().intersects(ball, 20)) {
	            snake.addTail();
	            ball = null;
	            points++;
	        }
	    ...
	    private void render(Graphics g) {
	        ...
	        if (ball != null) {
	          if (didLoadBallImage) {
	            g2d.drawImage(image, ball.getX(), ball.getY(), 60, 60, null);
	          } else {
	            g2d.setColor(Color.BLACK);
	    ...
	    public void spawnCherry() {
	        ball = new Point((new Random()).nextInt(WIDTH - 60) + 20,
